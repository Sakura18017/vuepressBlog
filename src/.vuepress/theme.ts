...
export default hopeTheme({
  hostname: "http://www.alorz.com",
  author: {
    name: "SakurArrivederci",
    url: "",
  },
  ...
  locales: {
    ...
    "/": {
      ...
      footer:
        '<a href="https://beian.miit.gov.cn/" target="_blank">陇ICP备20002494号-2</a>',
  ...
  plugins: {
    ...
    comment: {
      provider: "Giscus",
      repo: "Sakura18017/alorz-blog-vuepress",
      repoId: "R_kgDOJfBG5g",
      category: "Announcements",
      categoryId: "DIC_kwDOJfBG5s4CWRXE",
    },
